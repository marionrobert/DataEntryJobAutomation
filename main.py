...
for n in range(len(prices)):
    ...
    input_address.send_keys(prices[n])
    time.sleep(3)
    ...
    input_address.send_keys(links[n])
    time.sleep(3)
    print("send the form")
...
time.sleep(3)
print("get the results of the forms")
print("connect to google account")
connect_google = driver.find_element(By.XPATH, "/html/body/div/div[2]/form/div[2]/div/div[1]/div/div[4]/div/div/a[1]")
connect_google.click()
